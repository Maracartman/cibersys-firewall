package com.cibersys.firewall.RequestHandlers.SetUsuarioService;
 ...
 */
public interface SetUsuarioService extends AbstractRequestHandlerService<SetUsuarioReponseDTO> {
}
