package com.cibersys.firewall.RequestHandlers.UserVerification;
...
/**
 * Created by luismaracara on 17/06/17.
 */
public interface UserVerification extends AbstractRequestHandlerService<AbstractResponseBody>{
}
