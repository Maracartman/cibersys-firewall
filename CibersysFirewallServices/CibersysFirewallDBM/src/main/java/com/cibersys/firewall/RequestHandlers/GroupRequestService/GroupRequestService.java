package com.cibersys.firewall.RequestHandlers.GroupRequestService;
 ...
 */
public interface GroupRequestService extends
        AbstractPrivateRequestHandlerService<AbstractResponseBody,
                GroupRequestDTO>{
}
