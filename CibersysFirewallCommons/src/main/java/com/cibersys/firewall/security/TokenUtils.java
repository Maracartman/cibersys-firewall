...
public class TokenUtils {
    ...
    private final String AUTH_TOKEN = "auth";
    private final String INTERNAL_TOKEN = "internal";
    ...
    public TokenUtils(String s,Long e) {
        this.secret = s;
        this.expiration = e;
    }
    ...
    public UserDTO getUserFromToken(String token) {
        ...
        try {
            ...
            return mapper.readValue(new StringReader(user), UserDTO.class);
        } catch (Exception e) {
            return null;
        }
    }
    ...
    public String generateInternalToken() {
        Map<String, Object> claims = new HashMap<String, Object>();
        claims.put("sub","");
        claims.put("audience",INTERNAL_TOKEN);
        claims.put("created", this.generateCurrentDate());
        return this.generateToken(claims);
    }
    ...
    public Boolean validateToken(String token, UserDTO userDTODetails) {
        final String username = this.getUsernameFromToken(token);
        final Date created = this.getCreatedDateFromToken(token);
        final Date expiration = this.getExpirationDateFromToken(token);
        return (username.equals(userDTODetails.getUserName()) && !(this.isTokenExpired(token)));
    }
}
